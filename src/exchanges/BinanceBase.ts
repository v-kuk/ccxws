...
import { AssignedMarket, BasicRLClient, Socket } from "../BasicRLClient";
...
export class BinanceBase extends BasicRLClient {
    ...
    protected _onMessage(raw: string) {
        ...
        if (msg.stream.match(/@depth/)) {
            ...
            const update = this._constructLevel2Update(msg, market.market);
